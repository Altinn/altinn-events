...
public class ValidateSubscriptionHandlerTests
{
    ...
    public async Task Handle_ValidCommand_SendsWebhookAndMarksSubscriptionValid()
    {
        ...
        var command = new ValidateSubscriptionCommand { Subscription = subscription };
    ...
    public async Task Handle_SubscriptionWithDifferentIds_CreatesUniqueCloudEvents()
    {
        ...
        var command1 = new ValidateSubscriptionCommand { Subscription = subscription1 };
        var command2 = new ValidateSubscriptionCommand { Subscription = subscription2 };

        CloudEventEnvelope envelope1 = null;
        CloudEventEnvelope envelope2 = null;

        _webhookServiceMock
            .SetupSequence(x => x.SendAsync(It.IsAny<CloudEventEnvelope>()))
            .Callback<CloudEventEnvelope>(e => envelope1 = e)
            .Returns(Task.CompletedTask)
            .Callback<CloudEventEnvelope>(e => envelope2 = e)
            .Returns(Task.CompletedTask);
