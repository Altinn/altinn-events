...
-- The creator and consumer on each subscription below are invalid. The subscriptions were created to test the subscription matching. Not the consumer authorization.
...
-- Main unit that should only get main unit events.
SELECT events.insert_subscription('urn:altinn:resource:nabovarsel',        NULL, 'urn:altinn:organization:identifier-no:314249879', NULL, '/org/ttd',    'https://webhook.example.com/ttd-main',     '/org/ttd',    true,  NULL);
